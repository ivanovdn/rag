...
class Settings(BaseSettings):
    ...
    software_min_semantic_score: float = 0.40  # coarse cosine floor for the category (semantic) fallback; a fixed floor can't fully separate real categories from unknown-name near-misses (see Task 7 name-correspondence guard)
